...
router.post('/update-location', async (req, res) => {
    ...
    if (!driverId || latitude === undefined || longitude === undefined) {
        ...
        return res.status(400).json({ error: 'Missing required fields: driverId, latitude, and longitude are required' });
    }
    ...
    try {
        ...
        await redisClient.hSet(`driver:${driverId}`, 'latitude', latitude.toString());
        await redisClient.hSet(`driver:${driverId}`, 'longitude', longitude.toString());        
